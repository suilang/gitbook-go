...
示例 4.8 [type\_mixing.go](https://github.com/unknwon/the-way-to-go_ZH_CN/blob/master/eBook/examples/chapter_4/type_mixing.go)
...
**练习 4.4** 尝试编译 [divby0.go](https://github.com/unknwon/the-way-to-go_ZH_CN/blob/master/eBook/exercises/chapter_4/divby0.go)。
